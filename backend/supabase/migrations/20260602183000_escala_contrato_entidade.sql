-- Vincula escala/plantão ao contrato operacional da entidade.
...
COMMENT ON COLUMN escala_slots.contrato_entidade_id IS
  'Contrato da entidade que autoriza e fatura consultas deste plantão.';

COMMENT ON COLUMN escala_programacoes.contrato_entidade_id IS
  'Contrato padrão aplicado aos slots gerados nesta programação.';
