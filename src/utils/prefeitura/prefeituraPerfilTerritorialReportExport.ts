...
type ExportContext = { report: PerfilTerritorialReportApi; generatedAtLabel: string }
...
export function buildPerfilTerritorialReportHtml({ report, generatedAtLabel }: ExportContext) {
