...
import { computeProfissionalNotificacoesOriginSlices } from '../../../data/profissionalNotificacoesMock'
...
type ProfissionalNotificacoesSidebarPanelProps = {
...
export function ProfissionalNotificacoesSidebarPanel({
  notifications,
}: ProfissionalNotificacoesSidebarPanelProps) {
  const originSlices = useMemo(
    () => computeProfissionalNotificacoesOriginSlices(notifications),
    [notifications],
  )
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs text-gray-500">
                {formatNumber(totalMessages)} mensagens recebidas
              </p>
            </div>
            {totalUnread > 0 ? (
