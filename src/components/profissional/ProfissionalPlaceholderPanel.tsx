type ProfissionalPlaceholderPanelProps = {
  title: string
}

export function ProfissionalPlaceholderPanel({ title }: ProfissionalPlaceholderPanelProps) {
  return (
    <section
    ...
    >
      ...
      <p className="mt-2 max-w-md text-sm leading-relaxed text-gray-400">
        Esta área do painel profissional será disponibilizada em breve.
      </p>
    </section>
  )
}
