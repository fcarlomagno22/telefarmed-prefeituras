/** Duas colunas com scroll independente (xl+) e cards alinhados na base. */
export const suporteColumnScrollClass = [
  'min-h-0 min-w-0',
...
export const suporteColumnsGridClass = [
...
export const suporteColumnFillClass = 'flex h-full min-h-0 min-w-0 flex-col'
