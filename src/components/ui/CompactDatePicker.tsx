    ...
    <div ref={containerRef} className={`relative ${className}`.trim()}>
      ...
      {open ? (
        <div
          ...
          className="absolute left-0 top-[calc(100%+0.375rem)] z-50 w-[16.75rem] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-[0_16px_40px_rgba(15,23,42,0.16)]"
        >
