...
type PrefeituraNotificacoesSidebarPanelProps = {
  onCompose: () => void
}
  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col gap-3">
      <section className="shrink-0 rounded-2xl border border-gray-200 bg-white p-4 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_2px_10px_rgba(0,0,0,0.05)]">
        <h2 className="text-sm font-bold text-gray-900">Notificar a rede</h2>
        <p className="mt-0.5 text-xs leading-snug text-gray-500">
          UBT inteira, responsável ou operadoras cadastradas na unidade.
        </p>
        <button
          type="button"
          onClick={onCompose}
