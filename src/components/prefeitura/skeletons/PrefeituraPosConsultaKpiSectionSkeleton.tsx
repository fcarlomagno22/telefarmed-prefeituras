...
import { HorizontalBarsSkeleton, KpiCardsRowSkeleton } from './prefeituraSkeletonUi'

export function PrefeituraPosConsultaKpiSectionSkeleton() {
  return (
    <section className="min-w-0 xl:col-span-12">
      <div className="overflow-hidden rounded-2xl border border-gray-200/90 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.06)]">
        ...
        <div className="space-y-5 p-4 sm:p-5">
          <KpiCardsRowSkeleton count={4} className="grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4" variant="centered" />
