    ...
    <>
      ...
      >
        ...
        >
          ...
          <header className="relative z-20 shrink-0 overflow-visible border-b border-gray-200/80 bg-gradient-to-br from-[var(--brand-primary-light)]/70 to-[var(--brand-primary-muted)]/50 to-white px-5 py-5 sm:px-6">
