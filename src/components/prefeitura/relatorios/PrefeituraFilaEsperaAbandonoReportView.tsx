...
import {
  ...
  type FilaEsperaAbandonoReportApi,
} from '../../../lib/services/prefeitura/relatorios'
import { exportPrefeituraFilaEsperaAbandonoReportPdf } from '../../../utils/prefeitura/prefeituraFilaEsperaAbandonoReportExport'
import { formatDatePtBr } from '../../../utils/calendar'
import { PrefeituraFilaEsperaAbandonoReportDocument } from './PrefeituraFilaEsperaAbandonoReportDocument'
...
export function PrefeituraFilaEsperaAbandonoReportView() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        const data = await fetchPrefeituraFilaEsperaAbandonoReport(token, {
          periodStart,
          periodEnd,
        })
  ...
  const handleDownloadPdf = useCallback(async () => {
    ...
    try {
      await exportPrefeituraFilaEsperaAbandonoReportPdf({
        report,
