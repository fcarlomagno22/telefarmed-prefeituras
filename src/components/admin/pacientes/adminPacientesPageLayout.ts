export const adminPacientesColumnScrollClass = [
  'min-h-0 min-w-0',
...
export const adminPacientesMainColumnWrapClass = 'flex h-full min-h-0 min-w-0 flex-col'

export const adminPacientesSidebarColumnWrapClass = 'flex h-full min-h-0 min-w-0 flex-col'

export const adminPacientesColumnsGridClass = [
