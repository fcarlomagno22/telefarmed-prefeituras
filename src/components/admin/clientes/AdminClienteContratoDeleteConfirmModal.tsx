...
export function AdminClienteContratoDeleteConfirmModal({
  ...
  onCancel,
  onConfirm,
}: AdminClienteContratoDeleteConfirmModalProps) {
  if (!open) return null
  ...
  return createPortal(
    <div
      ...
      role="alertdialog"
      aria-modal="true"
      aria-labelledby="admin-contrato-delete-title"
      aria-describedby="admin-contrato-delete-description"
      onClick={onCancel}
    >
      <div
      ...
      >
        ...
        <h2 id="admin-contrato-delete-title" className="mt-4 text-lg font-bold text-gray-900">
          Excluir contrato?
        </h2>
        <p
          id="admin-contrato-delete-description"
