...
const cards: SummaryCard[] = [
  {
    ...
    value: adminClientesSummary.ativas,
    trend: adminClientesSummary.ativasTrend,
  ...
  },
  {
    ...
    value: adminClientesSummary.implantacao,
    trend: adminClientesSummary.implantacaoTrend,
  ...
  {
    label: 'Prospects',
    value: adminClientesSummary.prospects,
    trend: adminClientesSummary.prospectsTrend,
  ...
  {
    label: 'Suspensas',
    value: adminClientesSummary.suspensas,
    trend: adminClientesSummary.suspensasTrend,
