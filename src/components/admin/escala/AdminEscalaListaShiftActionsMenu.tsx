import { Eye, MoreVertical, PauseCircle, Pencil, Trash2 } from 'lucide-react'
import { useEffect, useLayoutEffect, useRef, useState, type CSSProperties } from 'react'
import { createPortal } from 'react-dom'

type AdminEscalaListaShiftActionsMenuProps = {
  label: string
  open: boolean
  canEdit?: boolean
  canDelete?: boolean
...
export function AdminEscalaListaShiftActionsMenu({
  label,
  open,
  canEdit = true,
  canDelete = true,
  ...
  onSuspend,
  onDelete,
}: AdminEscalaListaShiftActionsMenuProps) {
  ...
  }, [open, canEdit, canDelete, canSuspend])
    ...
    open && menuStyle ? (
      ...
      >
        ...
        {canEdit && canSuspend ? (
          ...
          >
            <PauseCircle className="h-4 w-4 shrink-0 text-amber-600" strokeWidth={2} />
            Suspender
          </button>
        ) : null}
        {canDelete ? (
