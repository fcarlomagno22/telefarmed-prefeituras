...
export const agendaChartSegments: AgendaChartSegment[] = [
  ...
  },
  {
    ...
    gradient: 'from-amber-400 via-orange-500 to-[#ff6b00]',
    glow: 'shadow-[0_0_8px_rgba(255,107,0,0.4)]',
    empty: 'bg-gray-100',
    printValueColor: '#ea580c',
    printGradient: 'linear-gradient(135deg, #fbbf24, #f97316, #ff6b00)',
    printGlow: '0 0 8px rgba(255, 107, 0, 0.4)',
    printEmptyColor: '#f3f4f6',
  },
  {
    key: 'scheduled',
