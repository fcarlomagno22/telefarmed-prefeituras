...
export type BodyCompositionPdfMeta = {
  patientName?: string
  logoSrc?: string
...
export function buildBodyCompositionReportFilename(): string {
  return `relatorio-composicao-${new Date().toISOString().slice(0, 10)}.pdf`
}

export async function createBodyCompositionReportPdf(
  report: BodyCompositionReportSummary,
  meta: BodyCompositionPdfMeta = {},
