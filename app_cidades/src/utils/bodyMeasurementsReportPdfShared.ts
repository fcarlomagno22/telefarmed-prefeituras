...
export type BodyMeasurementsPdfMeta = {
  patientName?: string
  logoSrc?: string
...
export function buildBodyMeasurementsReportHtml(
  report: BodyMeasurementsReportSummary,
...
export function buildBodyMeasurementsReportFilename(): string {
  return 'relatorio-medidas-corporais.pdf'
}

export async function createBodyMeasurementsReportPdf(
  report: BodyMeasurementsReportSummary,
  meta: BodyMeasurementsPdfMeta = {},
