...
export type ConsultationPdfMeta = {
  patientName?: string
}
...
export function buildConsultationDocumentHtml(
  document: ConsultationDocumentPdf,
  appointment: StoredAppointment,
...
export function buildConsultationDocumentFilename(document: ConsultationDocumentPdf): string {
  return `${document.kind}-consulta.pdf`
}

export async function resolveConsultationDocumentHtml(
  document: ConsultationDocumentPdf,
  appointment: StoredAppointment,
  meta: ConsultationPdfMeta = {},
): Promise<string> {
  ...
  return buildConsultationDocumentHtml(document, appointment, meta, logoSrc)
}
