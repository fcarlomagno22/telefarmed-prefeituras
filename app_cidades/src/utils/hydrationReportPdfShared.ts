...
export function buildHydrationReportHtml(
...
export function buildHydrationReportFilename(): string {
  return 'relatorio-hidratacao.pdf'
}

export async function createHydrationReportPdf(
  report: HydrationReportSummary,
  meta: HydrationPdfMeta = {},
