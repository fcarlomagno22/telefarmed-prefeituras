...
export function buildHeartRateReportHtml(
...
export function buildHeartRateReportFilename(): string {
  return 'relatorio-frequencia-cardiaca.pdf'
}

export async function createHeartRateReportPdf(
  report: HeartRateReportSummary,
  meta: HeartRatePdfMeta = {},
