...
export function buildRunWalkHistoryReportHtml(
  payload: RunWalkHistoryReportPayload,
  logoSrc: string,
) {
...
export function buildRunWalkHistoryReportFilename(): string {
  return 'relatorio-corrida-caminhada.pdf'
}

export async function createRunWalkHistoryReportPdf(
  payload: RunWalkHistoryReportPayload,
  ...
  const html = buildRunWalkHistoryReportHtml(payload, logoSrc)
  return createPdfFileFromHtml({
    html,
