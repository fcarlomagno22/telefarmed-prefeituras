...
const recoverySteps = [
  { id: 1, icon: 'card-outline' as const },
  { id: 2, icon: 'keypad-outline' as const },
  { id: 3, icon: 'lock-closed-outline' as const },
]
...
export function RecoveryTimeline({ currentStep }: RecoveryTimelineProps) {
  return (
