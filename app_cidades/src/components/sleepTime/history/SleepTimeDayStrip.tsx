...
function getSelectedIndex(days: SleepCalendarDay[], selectedDateIso: string) {
...
export function SleepTimeDayStrip({
  days,
  monthKey,
  selectedDateIso,
  onSelectDate,
          ...
          {days.map((day) => {
            ...
            return (
              ...
              >
                {selected ? (
                  <LinearGradient
                    colors={['rgba(99, 102, 241, 0.38)', 'rgba(67, 56, 202, 0.24)']}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 1 }}
