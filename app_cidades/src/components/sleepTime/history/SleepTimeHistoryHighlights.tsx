...
type SleepTimeHistoryHighlightsProps = {
  highlights: SleepHighlight[]
  onPressHighlight?: (highlight: SleepHighlight) => void
  onHorizontalScrollActive?: (active: boolean) => void
}

export function SleepTimeHistoryHighlights({
  highlights,
  onPressHighlight,
  onHorizontalScrollActive,
}: SleepTimeHistoryHighlightsProps) {
