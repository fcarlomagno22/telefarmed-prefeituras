...
import type { TdahTodConsentItem } from '../../tdahTodInfantil/types'
import { colors } from '../../theme/colors'
import { PrimaryButton } from '../PrimaryButton'
import { RunWalkSheetDrawer } from '../runWalk/RunWalkSheetDrawer'

type TdahTodConsentTermDrawerProps = {
  visible: boolean
  item: TdahTodConsentItem | null
  accepted: boolean
  onClose: () => void
  onAcceptChange: (accepted: boolean) => void
}

export function TdahTodConsentTermDrawer({
  visible,
  item,
  accepted,
  onClose,
  onAcceptChange,
}: TdahTodConsentTermDrawerProps) {
  if (!item) return null
