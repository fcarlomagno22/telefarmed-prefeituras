...
import { WORD_SEARCH_INTRO } from '../../../config/wordSearchHowToPlay'
import { colors } from '../../../theme/colors'
import { ActiveMindGameIcon } from '../ActiveMindGameIcon'
import type { ActiveMindGame } from '../../../types/activeMind'

type WordSearchIntroCardProps = {
  game: ActiveMindGame
  onHowToPlayPress: () => void
}

export function WordSearchIntroCard({ game, onHowToPlayPress }: WordSearchIntroCardProps) {
    ...
    <View style={styles.card}>
      <View style={styles.topRow}>
        ...
        <View style={styles.textCol}>
          <Text style={styles.title}>{WORD_SEARCH_INTRO.title}</Text>
          <Text style={styles.summary}>{WORD_SEARCH_INTRO.summary}</Text>
        </View>
      </View>

      <Text style={styles.rules}>{WORD_SEARCH_INTRO.rulesBrief}</Text>

      <Pressable
        onPress={handleHowToPlayPress}
        style={({ pressed }) => [styles.linkWrap, pressed && styles.linkWrapPressed]}
        accessibilityRole="button"
        accessibilityLabel="Como jogar Caça-palavras"
      >
