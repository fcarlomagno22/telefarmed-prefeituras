...
import { CROSSWORDS_INTRO } from '../../../config/crosswordsHowToPlay'
import { colors } from '../../../theme/colors'
import { ActiveMindGameIcon } from '../ActiveMindGameIcon'
import type { ActiveMindGame } from '../../../types/activeMind'

type CrosswordIntroCardProps = {
  game: ActiveMindGame
  onHowToPlayPress: () => void
}

export function CrosswordIntroCard({ game, onHowToPlayPress }: CrosswordIntroCardProps) {
    ...
    <View style={styles.card}>
      <View style={styles.topRow}>
        ...
        <View style={styles.textCol}>
          <Text style={styles.title}>{CROSSWORDS_INTRO.title}</Text>
          <Text style={styles.summary}>{CROSSWORDS_INTRO.summary}</Text>
        </View>
      </View>

      <Text style={styles.rules}>{CROSSWORDS_INTRO.rulesBrief}</Text>

      <Pressable
        onPress={handleHowToPlayPress}
        style={({ pressed }) => [styles.linkWrap, pressed && styles.linkWrapPressed]}
        accessibilityRole="button"
        accessibilityLabel="Como jogar Palavras cruzadas"
      >
