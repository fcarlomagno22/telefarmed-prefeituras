...
import { LOGIC_SEQUENCE_INTRO } from '../../../config/logicSequenceHowToPlay'
import { ActiveMindGameIcon } from '../ActiveMindGameIcon'
import type { ActiveMindGame } from '../../../types/activeMind'

type LogicSequenceIntroCardProps = {
  game: ActiveMindGame
  onHowToPlayPress: () => void
}

export function LogicSequenceIntroCard({ game, onHowToPlayPress }: LogicSequenceIntroCardProps) {
    ...
    <View style={styles.card}>
      <View style={styles.topRow}>
        ...
        <View style={styles.textCol}>
          <Text style={styles.title}>{LOGIC_SEQUENCE_INTRO.title}</Text>
          <Text style={styles.summary}>{LOGIC_SEQUENCE_INTRO.summary}</Text>
        </View>
      </View>

      <Text style={styles.rules}>{LOGIC_SEQUENCE_INTRO.rulesBrief}</Text>

      <Pressable
        onPress={handleHowToPlayPress}
        style={({ pressed }) => [styles.linkWrap, pressed && styles.linkWrapPressed]}
        accessibilityRole="button"
        accessibilityLabel="Como jogar Sequência lógica"
      >
